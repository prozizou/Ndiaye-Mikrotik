...
// Authentification via Google Sign-In uniquement (voir login/page.tsx) —
// plus d'email/mot de passe séparé à gérer.
...
export const fournisseurGoogle = new GoogleAuthProvider();
